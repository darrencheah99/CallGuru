...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference('Section.count') do
      post sections_url, params: { section: { playbook_id: @section.playbook_id, title: @section.title } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { playbook_id: @section.playbook_id, title: @section.title } }
