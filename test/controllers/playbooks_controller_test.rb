...
class PlaybooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playbook" do
    assert_difference('Playbook.count') do
      post playbooks_url, params: { playbook: { description: @playbook.description, name: @playbook.name, product_id: @playbook.product_id } }
    end
  ...
  test "should update playbook" do
    patch playbook_url(@playbook), params: { playbook: { description: @playbook.description, name: @playbook.name, product_id: @playbook.product_id } }
